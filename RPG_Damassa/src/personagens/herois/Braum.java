...
public class Braum extends Personagem {
    ...
    public String[] intro() {
        return new String[]{
                ...
                "Freljord não cairá enquanto Braum resistir."
        };
    }
    ...
    public void usarHabilidade(Personagem alvo) {
        ...
        System.out.println("1 - Pancada (150% de dano, 20% chance de atordoar) - 4 Pm");
        System.out.println("2 - O Escudo de Freljord (reduz 50% do dano recebido por 2 turnos) - 8 Pm");
        System.out.println("3 - Coração do Norte (cura e aumenta a defesa por 3 turnos) - 6 Pm");
